...
exports.default = function () {
  var base = (0, _baseIndicator2.default)()
    .type(ALGORITHM_TYPE)
    .fill(_defaultOptionsForAppearance.PivotPoint.fill)
    .stroke(_defaultOptionsForAppearance.PivotPoint.stroke)
    .stroke(_defaultOptionsForAppearance.PivotPoint.strokeWidth)
    .accessor(function (d) {
      return d.pivotPoint;
    });

  var underlyingAlgorithm = (0, _calculator.pivotPoint)();

  var mergedAlgorithm = (0, _utils.merge)()
    .algorithm(underlyingAlgorithm)
    .merge(function (datum, indicator) {
      datum.pivotPoint = indicator;
    });
