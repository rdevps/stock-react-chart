...
var YAxis = (function (_Component) {
  ...
  function YAxis(props, context) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (YAxis.__proto__ || Object.getPrototypeOf(YAxis)).call(
        this,
        props,
        context,
      ),
  ...
  _createClass(YAxis, [
    {
      ...
      value: function axisZoomCallback(newYDomain) {
        ...
        var zoomCallBack = this.props.zoomCallBack;
        zoomCallBack();
...
YAxis.propTypes = {
  axisAt: _propTypes2.default.oneOfType([
    _propTypes2.default.oneOf(['left', 'right', 'middle']),
...
function getYScale(moreProps) {
  ...
  if (scale.invert) {
    ...
    return scale.copy().domain([trueDomain[0], trueDomain[1]]).range(trueRange);
  }
  return scale;
}
