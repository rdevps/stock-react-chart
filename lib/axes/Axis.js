    ...
    },
    {
      ...
      value: function render() {
        ...
        var zoomCapture = zoomEnabled
          ? _react2.default.createElement(_AxisZoomCapture2.default, {
              bg: bg,
              getScale: getScale,
...
Axis.propTypes = {
  ...
  tickValues: _propTypes2.default.oneOfType([
...
function tickHelper(props, scale) {
  ...
  if ((0, _utils.isDefined)(tickValuesProp)) {
    ...
    var baseTickValues = (0, _d3Array.range)(
      min,
      max,
      (max - min) / tickInterval,
    );
  ...
  var format = (0, _utils.isNotDefined)(tickFormat)
    ? baseFormat
    : function (d) {
        return tickFormat(d) || '';
      };
  ...
  if (orient === 'bottom' || orient === 'top') {
    ...
    if (showTicks && flexTicks) {
      ...
      var simulation = (0, _d3Force.forceSimulation)(nodes)
        .force(
          'x',
          (0, _d3Force.forceX)(function (d) {
            return d.origX;
          }).strength(1),
        )
        .force('collide', (0, _d3Force.forceCollide)(22))
...
Tick.propTypes = {
  ...
  fontWeight: _propTypes2.default.oneOfType([
...
function drawEachTick(ctx, tick, result) {
  ...
  ctx.setLineDash(
    (0, _utils.getStrokeDasharray)(tickStrokeDasharray).split(','),
  );
  ctx.stroke();
}
