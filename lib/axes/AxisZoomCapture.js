...
var AxisZoomCapture = (function (_Component) {
  ...
  function AxisZoomCapture(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (
        AxisZoomCapture.__proto__ || Object.getPrototypeOf(AxisZoomCapture)
      ).call(this, props),
    );
  ...
  _createClass(AxisZoomCapture, [
    ...
    },
    {
      ...
      value: function handleRightClick(e) {
        ...
        (0, _d3Selection.select)((0, _utils.d3Window)(this.node))
    ...
    },
    {
      ...
      value: function handleDragStartMouse(e) {
        ...
        if (startScale.invert) {
          (0, _d3Selection.select)((0, _utils.d3Window)(this.node))
            .on(_utils.MOUSEMOVE, this.handleDrag, false)
            .on(_utils.MOUSEUP, this.handleDragEnd, false);
    ...
    },
    {
      ...
      value: function handleDragStartTouch(e) {
        ...
        if (e.touches.length === 1 && startScale.invert) {
          (0, _d3Selection.select)((0, _utils.d3Window)(this.node))
            .on(_utils.TOUCHMOVE, this.handleDrag)
            .on(_utils.TOUCHEND, this.handleDragEnd);

          var startXY = (0, _utils.touchPosition)(
    ...
    },
    {
      ...
      value: function handleDrag() {
        ...
        if ((0, _utils.isDefined)(startPosition)) {
          ...
          if (
            (0, _utils.sign)(
              (0, _utils.last)(startScale.range()) -
                (0, _utils.first)(startScale.range()),
            ) ===
            (0, _utils.sign)(
              (0, _utils.last)(tempRange) - (0, _utils.first)(tempRange),
            )
          ) {
    ...
    },
    {
      ...
      value: function render() {
        ...
        var cursor = (0, _utils.isDefined)(this.state.startPosition)
          ? zoomCursorClassName
          : 'react-stockcharts-default-cursor';

        return _react2.default.createElement('rect', {
          className:
            'react-stockcharts-enable-interaction ' + cursor + ' ' + className,
          ref: this.saveNode,
          x: bg.x,
          y: bg.y,
          opacity: 0,
