...
var BearAnnotation = (function (_Component) {
  _inherits(BearAnnotation, _Component);

  function BearAnnotation(props) {
    _classCallCheck(this, BearAnnotation);

    var _this = _possibleConstructorReturn(
      this,
      (BearAnnotation.__proto__ || Object.getPrototypeOf(BearAnnotation)).call(
        this,
        props,
      ),
    );
    ...
    },
    {
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement('text', props, 'BEAR'),
        );
      },
    },
  ]);

  return BearAnnotation;
})(_react.Component);
...
BearAnnotation.defaultProps = {
  className: 'react-stockcharts-bearannotation',
  opacity: 1,
  x: function x(_ref2) {
...
exports.default = BearAnnotation;
//# sourceMappingURL=BearAnnotation.js.map
