...
var Chart = (function (_PureComponent) {
  ...
  function Chart(props, context) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (Chart.__proto__ || Object.getPrototypeOf(Chart)).call(
        this,
        props,
        context,
      ),
...
Chart.propTypes = {
  ...
  origin: _propTypes2.default.oneOfType([
  ...
  yExtents: _propTypes2.default.oneOfType([
    _propTypes2.default.array,
    _propTypes2.default.func,
  ]),
  yExtentsCalculator: function yExtentsCalculator(
    props,
    propName,
    componentName,
  ) {
    if (
      (0, _utils.isNotDefined)(props.yExtents) &&
