...
function fitWidth(WrappedComponent) {
  ...
  var ResponsiveComponent = (function (_Component) {
    ...
    function ResponsiveComponent(props) {
      ...
      var _this = _possibleConstructorReturn(
        this,
        (
          ResponsiveComponent.__proto__ ||
          Object.getPrototypeOf(ResponsiveComponent)
        ).call(this, props),
      );
        ...
        value: function render() {
          ...
          if (this.state.width) {
            return _react2.default.createElement(
              WrappedComponent,
              _extends(
                { width: this.state.width, ratio: this.state.ratio },
                this.props,
                ref,
              ),
            );
  ...
  ResponsiveComponent.displayName =
    'fitWidth(' + getDisplayName(WrappedComponent) + ')';
