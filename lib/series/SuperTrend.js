...
var SuperTrend = (function (_Component) {
  _inherits(SuperTrend, _Component);

  function SuperTrend(props) {
    _classCallCheck(this, SuperTrend);

    var _this = _possibleConstructorReturn(
      this,
      (SuperTrend.__proto__ || Object.getPrototypeOf(SuperTrend)).call(
        this,
        props,
      ),
    );
  ...
  _createClass(SuperTrend, [
    ...
    },
    {
      ...
      value: function drawOnCanvas(ctx, moreProps) {
        ...
        var width =
          xScale(xAccessor((0, _utils.last)(plotData))) -
          xScale(xAccessor((0, _utils.first)(plotData)));
