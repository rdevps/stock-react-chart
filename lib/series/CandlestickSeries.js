...
var CandlestickSeries = (function (_Component) {
  ...
  function CandlestickSeries(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (
        CandlestickSeries.__proto__ || Object.getPrototypeOf(CandlestickSeries)
      ).call(this, props),
    );
...
CandlestickSeries.propTypes = {
  ...
  classNames: _propTypes2.default.oneOfType([
    _propTypes2.default.func,
  ...
  stroke: _propTypes2.default.oneOfType([
    _propTypes2.default.func,
    _propTypes2.default.string,
  ]),
  wickStroke: _propTypes2.default.oneOfType([
    _propTypes2.default.func,
    _propTypes2.default.string,
  ]),
...
CandlestickSeries.defaultProps = {
  ...
  //  wickStroke: '#eee',
  wickStroke: (d) => (d.close > d.open ? '#6BA583' : 'orange'),
...
function getCandlesSVG(props, candleData) {
  ...
  var candles = candleData.map(function (d, idx) {
    ...
    return _react2.default.createElement('rect', {
      key: idx,
      className: `${d.className} candle-width-height`,
      fillOpacity: opacity,
      x: d.x,
      y: d.y,
      width: d.width,
...
function _drawOnCanvas(ctx, props, moreProps) {
  ...
  var wickNest = (0, _d3Collection.nest)()
    .key(function (d) {
  ...
  var candleNest = (0, _d3Collection.nest)()
    .key(function (d) {
      return d.stroke;
    })
    .key(function (d) {
    ...
    strokeValues.forEach(function (inner) {
      ...
      var fillStyle =
        (0, _utils.head)(values).width <= 1
          ? key
          : (0, _utils.hexToRGBA)(key, opacity);
