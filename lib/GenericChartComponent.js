...
var GenericChartComponent = (function (_GenericComponent) {
  ...
  function GenericChartComponent(props, context) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (
        GenericChartComponent.__proto__ ||
        Object.getPrototypeOf(GenericChartComponent)
  ...
  _createClass(GenericChartComponent, [
    {
      ...
      value: function preCanvasDraw(ctx, moreProps) {
        _get(
          GenericChartComponent.prototype.__proto__ ||
            Object.getPrototypeOf(GenericChartComponent.prototype),
          'preCanvasDraw',
          this,
        ).call(this, ctx, moreProps);
        ctx.save();
    ...
    },
    {
      ...
      value: function updateMoreProps(moreProps) {
        ...
        if ((0, _utils.isDefined)(this.moreProps.chartConfig)) {
          var _moreProps$chartConfi2 = _slicedToArray(
              this.moreProps.chartConfig.origin,
              2,
            ),
    ...
    },
    {
      ...
      value: function shouldTypeProceed(type, moreProps) {
        ...
        if (
          ...
          (0, _utils.isDefined)(moreProps) &&
          (0, _utils.isDefined)(moreProps.currentCharts)
        ) {
...
GenericChartComponent.contextTypes = _extends(
  {},
  _GenericComponent3.default.contextTypes,
  {
    canvasOriginX: _propTypes2.default.number,
    canvasOriginY: _propTypes2.default.number,
    chartId: _propTypes2.default.oneOfType([
