...
exports.discontinuousTimeScaleProviderBuilder =
...
var _financeDiscontinuousScale2 = _interopRequireDefault(
...
function evaluateLevel(d, date, i, formatters) {
  return _levels.levelDefinition
    .map(function (eachLevel, idx) {
      return {
...
var discontinuousIndexCalculator = (0, _utils.slidingWindow)()
  .windowSize(2)
  .undefinedValue(function (d, idx, _ref) {
...
var discontinuousIndexCalculatorLocalTime =
  discontinuousIndexCalculator.accumulator(function (_ref2, i, idx, _ref3) {
...
function doStuff(
  ...
  return function (data) {
    ...
    var calculate = discontinuousIndexCalculatorLocalTime
      .source(dateAccessor)
      .misc({ initialIndex: initialIndex, formatters: formatters });
...
function discontinuousTimeScaleProviderBuilder() {
  ...
  var discontinuousTimeScaleProvider = function discontinuousTimeScaleProvider(
    data,
  ) {
    /*
