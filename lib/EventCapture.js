...
var EventCapture = (function (_Component) {
  ...
  function EventCapture(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (EventCapture.__proto__ || Object.getPrototypeOf(EventCapture)).call(
        this,
        props,
      ),
    );
  ...
  _createClass(EventCapture, [
    ...
    },
    {
      ...
      value: function componentDidMount() {
        if (this.node) {
          (0, _d3Selection.select)(this.node)
            .on(_utils.MOUSEENTER, this.handleEnter)
            .on(_utils.MOUSELEAVE, this.handleLeave);
        }
      },
    },
    {
    ...
    },
    {
      ...
      value: function componentWillUnmount() {
        if (this.node) {
          (0, _d3Selection.select)(this.node)
            .on(_utils.MOUSEENTER, null)
            .on(_utils.MOUSELEAVE, null);
    ...
    },
    {
      ...
      value: function handleRightClick(e) {
        ...
        var mouseXY = (0, _utils.mousePosition)(
          e,
        ...
        if ((0, _utils.isDefined)(this.state.panStart)) {
          ...
          var win = (0, _utils.d3Window)(this.node);
          (0, _d3Selection.select)(win)
            .on(_utils.MOUSEMOVE, null)
            .on(_utils.MOUSEUP, null);
    ...
    },
    {
      ...
      value: function cancelDrag() {
        var win = (0, _utils.d3Window)(this.node);
        (0, _d3Selection.select)(win)
          .on(_utils.MOUSEMOVE, this.mouseInside ? this.handleMouseMove : null)
          .on(_utils.MOUSEUP, null);
    ...
    },
    {
      ...
      value: function canPan() {
        ...
        var _getAllPanConditions$ = getAllPanConditions().reduce(
      ...
      value: function handleMouseDown(e) {
        ...
        if (!this.state.panInProgress && this.mouseInteraction) {
          ...
          if (pan) {
            ...
            var win = (0, _utils.d3Window)(this.node);
            (0, _d3Selection.select)(win)
              .on(_utils.MOUSEMOVE, this.handlePan)
              .on(_utils.MOUSEUP, this.handlePanEnd);
            ...
            (0, _d3Selection.select)(_win)
              .on(_utils.MOUSEMOVE, this.handleDrag)
              .on(_utils.MOUSEUP, this.handleDragEnd);
          }
    ...
    },
    {
      ...
      value: function shouldPan() {
        ...
        return (
          panEnabled && onPan && (0, _utils.isDefined)(this.state.panStart)
        );
      },
    },
    {
      ...
      value: function handlePan() {
        ...
        if (this.shouldPan()) {
          ...
          var mouseXY = this.mouseInteraction
            ? (0, _d3Selection.mouse)(this.node)
            : (0, _d3Selection.touches)(this.node)[0];
      ...
      value: function handlePanEnd() {
        ...
        if ((0, _utils.isDefined)(this.state.panStart)) {
          ...
          (0, _d3Selection.select)(win)
            ...
            .on(_utils.MOUSEUP, null)
            .on(_utils.TOUCHMOVE, null)
            .on(_utils.TOUCHEND, null);
    ...
    },
    {
      ...
      value: function handleTouchMove(e) {
        ...
        var touchXY = (0, _utils.touchPosition)(
          (0, _utils.getTouchProps)(e.touches[0]),
          e,
        );
      ...
      value: function handleTouchStart(e) {
        ...
        if (e.touches.length === 1) {
          ...
          if (panEnabled) {
            ...
            var win = (0, _utils.d3Window)(this.node);
            (0, _d3Selection.select)(win)
              .on(_utils.TOUCHMOVE, this.handlePan, false)
              .on(_utils.TOUCHEND, this.handlePanEnd, false);
          }
          ...
          if (panInProgress && panEnabled && onPanEnd) {
            ...
            (0, _d3Selection.select)(_win2)
              .on(
                _utils.MOUSEMOVE,
                this.mouseInside ? this.handleMouseMove : null,
              )
              .on(_utils.MOUSEUP, null)
              .on(_utils.TOUCHMOVE, this.handlePinchZoom, false)
              .on(_utils.TOUCHEND, this.handlePinchZoomEnd, false);

            var touch1Pos = (0, _utils.touchPosition)(
              (0, _utils.getTouchProps)(e.touches[0]),
              e,
            );
            var touch2Pos = (0, _utils.touchPosition)(
              (0, _utils.getTouchProps)(e.touches[1]),
              e,
            );
    ...
    },
    {
      ...
      value: function handlePinchZoom() {
        ...
        var _state$pinchZoomStart = this.state.pinchZoomStart,
          ...
          initialPinch = _objectWithoutProperties(_state$pinchZoomStart, [
            'chartsToPan',
          ]);
    ...
    },
    {
      ...
      value: function handlePinchZoomEnd() {
        ...
        var _state$pinchZoomStart2 = this.state.pinchZoomStart,
          ...
          initialPinch = _objectWithoutProperties(_state$pinchZoomStart2, [
            'chartsToPan',
          ]);
