...
function calculateFullData(props) {
  ...
  var useWholeData = (0, _utils.isDefined)(plotFull)
    ? plotFull
...
function resetChart(props) {
  ...
  var chartConfig = (0, _ChartDataUtil.getChartConfigWithUpdatedYScales)(
    (0, _ChartDataUtil.getNewChartConfig)(dimensions, children),
    {
      plotData: plotData,
      xAccessor: xAccessor,
...
function updateChart(
  ...
  if (!lastItemWasVisible || end >= xAccessor(lastItem)) {
    ...
    var newStart = maintainPointsPerPixelOnResize
      ? end - newDomainExtent
      : start;

    var lastItemX = initialXScale(xAccessor(lastItem));
    var response = filterData(
      fullData,
      [newStart, end],
      xAccessor,
      updatedXScale,
      {
        fallbackStart: start,
        fallbackEnd: { lastItem: lastItem, lastItemX: lastItemX },
      }
    );
    ...
    var _initialXScale$range$ = initialXScale
        .range()
        .map(function (x) {
          return x + dx;
        })
  ...
  var plotData = postCalculator(initialPlotData);
  var chartConfig = (0, _ChartDataUtil.getChartConfigWithUpdatedYScales)(
    (0, _ChartDataUtil.getNewChartConfig)(
      dimensions,
      children,
      initialChartConfig
    ),
...
function calculateState(props) {
  ...
  if (
    ...
    (0, _utils.isDefined)(props.xScale.invert)
  ) {
  ...
  if (process.env.NODE_ENV !== "production" && plotData.length <= 1) {
    throw new Error(
      "Showing " +
        plotData.length +
        " datapoints, review the 'xExtents' prop of ChartCanvas"
    );
  }
  return {
    plotData: plotData,
...
var ChartCanvas = (function (_Component) {
  ...
  function ChartCanvas() {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (ChartCanvas.__proto__ || Object.getPrototypeOf(ChartCanvas)).call(this)
    );
  ...
  _createClass(ChartCanvas, [
    ...
    },
    {
      ...
      value: function subscribe(id, rest) {
        var _rest$getPanCondition = rest.getPanConditions,
          getPanConditions =
            _rest$getPanCondition === undefined
              ? (0, _utils.functor)({
                  draggable: false,
                  panEnabled: true,
                })
    ...
    },
    {
      ...
      value: function amIOnTop(id) {
        ...
        return (
          dragableComponents.length > 0 &&
          (0, _utils.last)(dragableComponents).id === id
        );
      },
    },
    {
      ...
      value: function handleContextMenu(mouseXY, e) {
        ...
        var currentCharts = (0, _ChartDataUtil.getCurrentCharts)(
          chartConfig,
          mouseXY
        );
    ...
    },
    {
      ...
      value: function pinchZoomHelper(initialPinch, finalPinch) {
        ...
        var xDash = Math.round(
          -(iBR[0] * fTL[0] - iTL[0] * fBR[0]) / (iTL[0] - iBR[0])
        );
        var yDash = Math.round(
          e +
    ...
    },
    {
      ...
      value: function panHelper(mouseXY, initialXScale, _ref2, chartsToPan) {
        ...
        if ((0, _utils.isNotDefined)(initialXScale.invert))
          throw new Error(
    ...
    },
    {
      ...
      value: function componentWillReceiveProps(nextProps) {
        ...
        var interaction = isInteractionEnabled(
          this.state.xScale,
        ...
        if (
          !interaction ||
          reset ||
          !(0, _utils.shallowEqual)(this.props.xExtents, nextProps.xExtents)
        ) {
          if (process.env.NODE_ENV !== "production") {
            if (!interaction)
    ...
    },
    {
      ...
      value: function resetYDomain(chartId) {
        ...
        var newChartConfig = chartConfig.map(function (each) {
          if (
            ((0, _utils.isNotDefined)(chartId) || each.id === chartId) &&
            !(0, _utils.shallowEqual)(each.yScale.domain(), each.realYDomain)
          ) {
            changed = true;
            return _extends({}, each, {
...
function isInteractionEnabled(xScale, xAccessor, data) {
  var interaction =
    !isNaN(xScale(xAccessor((0, _utils.head)(data)))) &&
    (0, _utils.isDefined)(xScale.invert);
  return interaction;
}
...
ChartCanvas.propTypes = {
  ...
  xExtents: _propTypes2.default.oneOfType([
  ...
  clamp: _propTypes2.default.oneOfType([
  ...
  drawInteraction: _propTypes2.default.bool,
};
...
ChartCanvas.childContextTypes = {
  ...
  chartConfig: _propTypes2.default.arrayOf(
    _propTypes2.default.shape({
      id: _propTypes2.default.oneOfType([
        _propTypes2.default.number,
        _propTypes2.default.string,
      ]).isRequired,
      origin: _propTypes2.default.arrayOf(_propTypes2.default.number)
        .isRequired,
      padding: _propTypes2.default.oneOfType([
        _propTypes2.default.number,
        _propTypes2.default.shape({
