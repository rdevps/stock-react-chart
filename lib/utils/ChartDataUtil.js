...
function getNewChartConfig(innerDimension, children) {
  ...
  return _react2.default.Children.map(children, function (each) {
    if (each && each.type.toString() === _Chart2.default.toString()) {
      ...
      var yExtents = (0, _index.isDefined)(yExtentsProp)
      ...
      if (isArraySize2AndNumber(yExtentsProp)) {
        if (
          (0, _index.isDefined)(prevChartConfig) &&
          prevChartConfig.yPan &&
          prevChartConfig.yPanEnabled &&
          yPan &&
          yPanEnabled &&
          (0, _index.shallowEqual)(
            prevChartConfig.originalYExtentsProp,
            yExtentsProp,
          )
        ) {
...
function getCurrentCharts(chartConfig, mouseXY) {
  var currentCharts = chartConfig
    .filter(function (eachConfig) {
...
function yDomainFromYExtents(yExtents, yScale, plotData) {
  ...
  var realYDomain = yScale.invert
    ? (0, _d3Array.extent)(allYValues)
    : (0, _d3Collection.set)(allYValues).values();
...
function getChartConfigWithUpdatedYScales(
  ...
  var yDomains = chartConfig.map(function (_ref4) {
    ...
    var realYDomain = (0, _index.isDefined)(yExtentsCalculator)
      ? yExtentsCalculator({
          plotData: plotData,
          xDomain: xDomain,
          xAccessor: xAccessor,
    ...
    var yDomainDY = (0, _index.isDefined)(dy)
      ? yScale
          .range()
          .map(function (each) {
            return each - dy;
  ...
  var combine = (0, _index.zipper)().combine(function (config, _ref5) {
    ...
    var id = config.id,
      ...
      yPanEnabled =
        _config$yPanEnabled === undefined ? false : _config$yPanEnabled;

    var another = (0, _index.isDefined)(chartsToPan)
      ? chartsToPan.indexOf(id) > -1
      : true;
    var domain =
      yPan && yPanEnabled ? (another ? yDomainDY : prevYDomain) : realYDomain;

    var newYScale = setRange(
