...
var BackgroundText = (function (_PureComponent) {
  ...
  function BackgroundText() {
    ...
    return _possibleConstructorReturn(
      this,
      (BackgroundText.__proto__ || Object.getPrototypeOf(BackgroundText)).apply(
        this,
        arguments,
      ),
    );
  ...
  _createClass(BackgroundText, [
    {
      ...
      value: function componentDidMount() {
        if (
          ...
          (0, _utils.isDefined)(this.context.getCanvasContexts)
        ) {
          var contexts = this.context.getCanvasContexts();
          console.log('BackgroundText contexts', contexts)
          if (contexts)
    ...
    },
    {
      ...
      value: function render() {
        ...
        return _react2.default.createElement('text', props, text);
      },
    },
  ]);
...
BackgroundText.drawOnCanvas = function (ctx, props, _ref, getText) {
  console.log('BackgroundText getText', getText)
