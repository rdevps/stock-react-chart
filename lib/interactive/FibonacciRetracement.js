...
var FibonacciRetracement = (function (_Component) {
  ...
  function FibonacciRetracement(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (
        FibonacciRetracement.__proto__ ||
        Object.getPrototypeOf(FibonacciRetracement)
      ).call(this, props),
    );
    ...
    },
    {
      ...
      value: function handleStart(xyValue, moreProps) {
        ...
        if (
          ...
          (0, _utils.isNotDefined)(current.x1)
        ) {
    ...
    },
    {
      ...
      value: function handleEnd(xyValue, moreProps, e) {
        ...
        if (
          ...
          var newRetracements = retracements.concat(
            _extends({}, current, {
              x2: xyValue[0],
              y2: xyValue[1],
              selected: true,
    ...
    },
    {
      ...
      value: function render() {
        ...
        var overrideIndex = (0, _utils.isDefined)(override)
          ? override.index
          : null;
        var hoverTextWidthDefault = selectedInteraction
          ? _extends({}, FibonacciRetracement.defaultProps.hoverText, hoverText)
          : {};

        var currentRetracement =
          (0, _utils.isDefined)(current) && (0, _utils.isDefined)(current.x2)
            ? _react2.default.createElement(
                _EachFibRetracement2.default,
                _extends(
                  {
                    interactive: false,
                    type: type,
        ...
        return _react2.default.createElement(
          ...
          retracements.map(function (each, idx) {
            ...
            var eachHoverText = (0, _utils.isDefined)(each.hoverText)
              ? _extends({}, hoverTextWidthDefault, each.hoverText)
