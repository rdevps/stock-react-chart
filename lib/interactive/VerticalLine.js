...
var _EachVerticalLine = require('./wrapper/EachVerticalLine');

var _EachVerticalLine2 = _interopRequireDefault(_EachVerticalLine);
...
var VerticalLine = (function (_Component) {
  ...
  function VerticalLine(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (VerticalLine.__proto__ || Object.getPrototypeOf(VerticalLine)).call(
        this,
        props,
      ),
    );
          ...
          trends.map(function (each, idx) {
            ...
            var hoverTextWithDefault =
              (_props2.selectedInteraction &&
                _extends({}, VerticalLine.defaultProps.hoverText, hoverText)) ||
              {};

            return _react2.default.createElement(_EachVerticalLine2.default, {
              key: idx,
...
VerticalLine.propTypes = {
  ...
  type: _propTypes2.default.oneOf(
    ['VXLINE'], // extends between the set bounds
  ),
