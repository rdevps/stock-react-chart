...
var ShortPosition = function (_Component) {
	_inherits(ShortPosition, _Component);

	function ShortPosition(props) {
		_classCallCheck(this, ShortPosition);

		var _this = _possibleConstructorReturn(this, (ShortPosition.__proto__ || Object.getPrototypeOf(ShortPosition)).call(this, props));
	...
	_createClass(ShortPosition, [{
		...
		value: function render() {
			...
			var eachDefaultAppearance = _extends({}, ShortPosition.defaultProps.appearance, appearance);

			var hoverTextDefault = _extends({}, ShortPosition.defaultProps.hoverText, hoverText);
...
ShortPosition.propTypes = {
	...
	appearance: _propTypes2.default.shape({
		...
		baseFill: _propTypes2.default.string,
		upFill: _propTypes2.default.string,
		downFill: _propTypes2.default.string,
...
exports.default = ShortPosition;
//# sourceMappingURL=ShortPosition.js.map