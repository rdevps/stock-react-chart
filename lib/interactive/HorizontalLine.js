...
var _EachHorizontalLine = require('./wrapper/EachHorizontalLine');

var _EachHorizontalLine2 = _interopRequireDefault(_EachHorizontalLine);
...
var HorizontalLine = (function (_Component) {
  ...
  function HorizontalLine(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (HorizontalLine.__proto__ || Object.getPrototypeOf(HorizontalLine)).call(
        this,
        props,
      ),
    );
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          trends.map(function (each, idx) {
            ...
            return _react2.default.createElement(_EachHorizontalLine2.default, {
              key: idx,
...
HorizontalLine.propTypes = {
  ...
  type: _propTypes2.default.oneOf(
    ['HXLINE'], // extends between the set bounds
  ),
