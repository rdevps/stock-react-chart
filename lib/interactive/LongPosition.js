...
var _EachLongPosition = require('./wrapper/EachLongPosition');

var _EachLongPosition2 = _interopRequireDefault(_EachLongPosition);
...
var LongPosition = (function (_Component) {
  _inherits(LongPosition, _Component);

  function LongPosition(props) {
    _classCallCheck(this, LongPosition);

    var _this = _possibleConstructorReturn(
      this,
      (LongPosition.__proto__ || Object.getPrototypeOf(LongPosition)).call(
        this,
        props,
      ),
    );
    ...
    _this.handleDragChannelComplete =
      _this.handleDragChannelComplete.bind(_this);
  ...
  _createClass(LongPosition, [
      ...
      value: function handleDragChannelComplete(moreProps) {
        ...
        if ((0, _utils.isDefined)(override)) {
          ...
          var newChannels = channels.map(function (each, idx) {
            return idx === index
              ? _extends({}, each, rest, { selected: true })
              : each;
          });
          this.setState(
            {
    ...
    },
    {
      ...
      value: function handleDrawChannel(xyValue) {
        ...
        // [current.endXY[0],current.startXY[1]]
        if (
          (0, _utils.isDefined)(current) &&
          (0, _utils.isDefined)(current.startXY)
        ) {
          ...
          if ((0, _utils.isNotDefined)(current.dy)) {
            this.setState({
              current: {
                ...
                endXY: [xyValue[0], current.startXY[1]],
              },
            });
          } else {
            var m = (0, _StraightLine.getSlope)(current.startXY, [
              current.endXY[0],
              current.startXY[1],
            ]);
            var b = (0, _StraightLine.getYIntercept)(m, [
              current.endXY[0],
              current.startXY[1],
            ]);
            var y = m * xyValue[0] + b;
    ...
    },
    {
      ...
      value: function handleStart(xyValue) {
        ...
        if (
          ...
          (0, _utils.isNotDefined)(current.startXY)
        ) {
    ...
    },
    {
      ...
      value: function render() {
        ...
        var overrideIndex = (0, _utils.isDefined)(override)
          ? override.index
          : null;

        var tempChannel =
          (0, _utils.isDefined)(current) && (0, _utils.isDefined)(current.endXY)
            ? _react2.default.createElement(
                _EachLongPosition2.default,
                _extends(
                  {
                    interactive: false,
                  },
            ...
            return _react2.default.createElement(
              ...
              _extends(
                ...
                idx === overrideIndex ? override : each,
                {
                  ...
                  infoBar: {
                    start: channels[idx].startXY[1] + channels[idx].dy,
                    diff: channels[idx].dy,
                    end: channels[idx].endXY[1],
                  },
...
exports.default = LongPosition;
//# sourceMappingURL=LongPosition.js.map
