...
var DrawingObjectSelector = (function (_Component) {
  ...
  function DrawingObjectSelector(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (
        DrawingObjectSelector.__proto__ ||
        Object.getPrototypeOf(DrawingObjectSelector)
      ).call(this, props),
    );
  ...
  _createClass(DrawingObjectSelector, [
    {
      ...
      value: function handleDoubleClick(moreProps, e) {
        ...
        if (allSelected.length > 0) {
          ...
          var morePropsForChart = (0, _utils2.getMorePropsForChart)(
            moreProps,
            selected.chartId,
          );
    ...
    },
    {
      ...
      value: function getInteraction(moreProps) {
        ...
        var interactives = (0, _utils.mapObject)(
          interactiveNodes,
          function (each) {
            var key = drawingObjectMap[each.type];

            var valueArray = (0, _utils.isDefined)(key)
              ? each.node.props[key]
              : undefined;

            var valuePresent =
              (0, _utils.isDefined)(valueArray) &&
