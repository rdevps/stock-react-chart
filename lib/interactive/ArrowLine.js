...
var _EachArrowLine = require('./wrapper/EachArrowLine');

var _EachArrowLine2 = _interopRequireDefault(_EachArrowLine);
...
var ArrowLine = (function (_Component) {
  _inherits(ArrowLine, _Component);
  ...
  function ArrowLine(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (ArrowLine.__proto__ || Object.getPrototypeOf(ArrowLine)).call(
        this,
        props,
      ),
    );
        ...
        var tempLine =
          (0, _utils.isDefined)(current) && (0, _utils.isDefined)(current.end)
            ? _react2.default.createElement(
              ...
              _react2.default.createElement(_EachArrowLine2.default, {
                type: type,
                noHover: true,
                isLocked: false,
                x1Value: current.start[0],
                ...
                strokeOpacity: appearance.strokeOpacity || 1,
        ...
        return _react2.default.createElement(
          ...
          trends.map(function (each, idx) {
            ...
            var hoverTextWithDefault = _extends(
              {},
              ArrowLine.defaultProps.hoverText,
              hoverText,
            );

            return _react2.default.createElement(_EachArrowLine2.default, {
              key: idx,
