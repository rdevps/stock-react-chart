...
var _EachRectangleChannel = require('./wrapper/EachRectangleChannel');

var _EachRectangleChannel2 = _interopRequireDefault(_EachRectangleChannel);
...
var RectangleChannel = (function (_Component) {
  _inherits(RectangleChannel, _Component);

  function RectangleChannel(props) {
    _classCallCheck(this, RectangleChannel);

    var _this = _possibleConstructorReturn(
      this,
      (
        RectangleChannel.__proto__ || Object.getPrototypeOf(RectangleChannel)
      ).call(this, props),
    );
        ...
        var tempLine =
          (0, _utils.isDefined)(current) && (0, _utils.isDefined)(current.end)
            ? _react2.default.createElement(
              ...
              _react2.default.createElement(_EachRectangleChannel2.default, {
                type: type,
                noHover: true,
                x1Value: current.start[0],
                y1Value: current.start[1],
                ...
                fillOpacity: appearance.fillOpacity || .5,
        ...
        return _react2.default.createElement(
          ...
          trends.map(function (each, idx) {
            ...
            var hoverTextWithDefault = _extends(
              {},
              RectangleChannel.defaultProps.hoverText,
              hoverText,
            );

            return _react2.default.createElement(
              _EachRectangleChannel2.default,
              {
                key: idx,
                ...
                line1: (0, _utils2.getValueFromOverride)(
                  override,
                  idx,
                  'line1',
                  each.line1,
                ),
                line2: (0, _utils2.getValueFromOverride)(
                  override,
                  idx,
                  'line2',
                  each.line2,
                ),
                line3: (0, _utils2.getValueFromOverride)(
                  override,
                  idx,
                  'line3',
                  each.line3,
                ),
                line4: (0, _utils2.getValueFromOverride)(
                  override,
                  idx,
                  'line4',
                  each.line4,
                ...
                fillOpacity: eachAppearance.fillOpacity || .5,
  ...
  return RectangleChannel;
})(_react.Component);

RectangleChannel.propTypes = {
...
exports.default = RectangleChannel;
//# sourceMappingURL=RectangleChannel.js.map
