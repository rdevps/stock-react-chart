  ...
  _createClass(EachShortPositionChannel, [
    ...
    },
    {
      ...
      value: function handleEdge1Drag(moreProps) {
        ...
        if (y1Value < upCircle[1] && y1Value > downCircle[1]) {
          ...
          // handleEdgeDrag(moreProps, [x1Value, y1Value], [x2Value, y1Value]);
        }
      },
    },
    {
      ...
      value: function handleEdge2Drag(moreProps) {
        var _props6 = this.props,
          index = _props6.index,
          handleEdgeDrag = _props6.handleEdgeDrag,
    ...
    },
    {
      ...
      value: function render() {
        ...
        var middleText1 = `Trade: ${y2Value.toFixed(2)}, ${!plCandle ? 'Open' : 'Closed'
          } P&L: ${pl},`;
