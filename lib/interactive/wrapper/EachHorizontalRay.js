...
var EachHorizontalRay = (function (_Component) {
  _inherits(EachHorizontalRay, _Component);

  function EachHorizontalRay(props) {
    _classCallCheck(this, EachHorizontalRay);

    var _this = _possibleConstructorReturn(
      this,
      (
        EachHorizontalRay.__proto__ || Object.getPrototypeOf(EachHorizontalRay)
      ).call(this, props),
    );
  ...
  _createClass(EachHorizontalRay, [
    {
    ...
    },
    {
      ...
      value: function handleLineDrag(moreProps) {
        ...
        this.setState({ x2Value: moreProps.width });
        if (this.state.hover)
          onDrag(index, {
            x1Value: newX1Value,
            y1Value: newY1Value,
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(_ClickableCircle2.default, {
            ...
            strokeOpacity: 1,
            interactiveCursorClass: isLocked ? () => { } : edgeInteractiveCursor,
...
EachHorizontalRay.propTypes = {
  x1Value: _propTypes2.default.any,
  x2Value: _propTypes2.default.any,
...
EachHorizontalRay.defaultProps = {
  onDrag: _utils.noop,
...
exports.default = EachHorizontalRay;
//# sourceMappingURL=EachHorizontalRay.js.map
