    ...
    },
    {
      ...
      value: function handleChannelHeightChange(moreProps) {
        var _props5 = this.props,
          index = _props5.index,
          startItem = _props5.startItem,
          lastItem = _props5.lastItem,
        ...
        var line2Edge = (0, _utils.isDefined)(dy)
          ? _react2.default.createElement(
            ...
            this.getEdgeCircle({
              ...
              onDoubleClickWhenHover: isLocked
                ? () => { }
                : this.onDoubleClickWhenHover,
              onClick: this.handleClick,
