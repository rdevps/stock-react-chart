...
var EachEquidistantChannel = (function (_Component) {
  ...
  function EachEquidistantChannel(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (
        EachEquidistantChannel.__proto__ ||
        Object.getPrototypeOf(EachEquidistantChannel)
      ).call(this, props),
    );
        ...
        var line1Edge =
          (0, _utils.isDefined)(startXY) && (0, _utils.isDefined)(endXY)
            ? _react2.default.createElement(
              ...
              this.getEdgeCircle({
                xy: startXY,
                dragHandler: isLocked ? () => { } : this.handleLine1Edge1Drag,
              ...
              this.getEdgeCircle({
                xy: endXY,
                dragHandler: isLocked ? () => { } : this.handleLine1Edge2Drag,
                onClick: this.handleClick,
                cursor: 'react-stockcharts-move-cursor',
                fill: edgeFill,
                edge: 'line1edge2',
            ...
            : null;
        var line2Edge = (0, _utils.isDefined)(dy)
          ? _react2.default.createElement(
            'g',
            null,
            this.getEdgeCircle({
              xy: [startXY[0], startXY[1] + dy],
              dragHandler: isLocked
                ? () => { }
        ...
        if (_props6.type === 'RECT') {
          line1Edge =
            (0, _utils.isDefined)(startXY) && (0, _utils.isDefined)(endXY)
              ...
              : null;
          line2Edge = (0, _utils.isDefined)(dy)
            ? _react2.default.createElement(
              'g',
              null,
              this.getEdgeCircle({
            ...
            _react2.default.createElement(
              ...
              _extends(
                ...
                hoverHandler,
                {
                  ...
                  onClick: this.handleClick,
                  onDragStart: isLocked ? () => { } : this.handleDragStart,
                  onDrag: isLocked ? () => { } : this.handleChannelDrag,
