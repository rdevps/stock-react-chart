...
var _ClickableCallOut = require('../components/ClickableCallOut');

var _ClickableCallOut2 = _interopRequireDefault(_ClickableCallOut);

var _ClickableCircle = require('../components/ClickableCircle');

var _ClickableArrow = require('../components/ClickableArrow');

var _ClickableCircle2 = _interopRequireDefault(_ClickableCircle);

var _EachCalloutText = require('../components/EachCalloutText');

var _EachCalloutText2 = _interopRequireDefault(_EachCalloutText);
...
var EachCallout = (function (_Component) {
  _inherits(EachCallout, _Component);

  function EachCallout(props) {
    _classCallCheck(this, EachCallout);

    var _this = _possibleConstructorReturn(
      this,
      (EachCallout.__proto__ || Object.getPrototypeOf(EachCallout)).call(
        this,
        props,
      ),
    );
    ...
    },
    {
      ...
      value: function render() {
        ...
        var hoverTextEnabled = hoverText.enable,
          hoverTextSelected = 'Testing test',
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(_ClickableCallOut2.default, {
            ref: this.saveNodeType('edge1'),
            show: selected || hover,
            cx: x2Value,
            cy: y2Value,
          ...
          _react2.default.createElement(_EachCalloutText2.default, {
            ref: this.saveNodeType('edge2'),
            show: selected || hover,
            ...
            onDragComplete: isLocked ? () => { } : this.handleDragComplete,
            onClick: this.handleClick,
            onHover: isLocked ? () => { } : this.handleHover,
            onUnHover: isLocked ? () => { } : this.handleHover,
          }),
        );
      },
    },
...
EachCallout.propTypes = {
  ...
  type: _propTypes2.default.oneOf(
    ['EachCallout'], // extends between the set bounds
  ).isRequired,
...
exports.default = EachCallout;
//# sourceMappingURL=EachCallout.js.map
