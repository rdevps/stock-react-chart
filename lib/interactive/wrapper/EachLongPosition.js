...
var _ChannelWithRect = require('../components/ChannelWithRect');

var _ChannelWithRect2 = _interopRequireDefault(_ChannelWithRect);
...
var EachLongPosition = (function (_Component) {
  _inherits(EachLongPosition, _Component);

  function EachLongPosition(props) {
    _classCallCheck(this, EachLongPosition);

    var _this = _possibleConstructorReturn(
      this,
      (
        EachLongPosition.__proto__ || Object.getPrototypeOf(EachLongPosition)
      ).call(this, props),
    );
    ...
    _this.handleChannelHeightChange =
      _this.handleChannelHeightChange.bind(_this);
  ...
  _createClass(EachLongPosition, [
    ...
    },
    {
      ...
      value: function getEdgeCircle(_ref) {
        ...
        var infoBar = this.props.infoBar;
    ...
    },
    {
      ...
      value: function render() {
        ...
        // var line1 =
        //   (0, _utils.isDefined)(startXY) && (0, _utils.isDefined)(endXY)
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(_PositionTextWithRect2.default, {
            ...
            show: selected || hover,
            cx: (startXY[0] + endXY[0]) / 2,
            cy: (startXY[1] + endXY[1]) / 2,
            x1Value: startXY[0],
            y1Value: startXY[1],
            x2Value: endXY[0],
            y2Value: endXY[1],
            r: r,
            fill: Math.sign(dy) >= 0 ? '#2863FF' : '#ef5350',
            fillOpacity: 1,
            textColor: '#eee',
            fontSize: 12,
            stroke: Math.sign(dy) >= 0 ? '#2863FF' : '#ef5350',
            strokeWidth: 0,
            strokeOpacity: 1,
            infoBar: infoBar,
            ...
            onDragComplete: this.getEdgeCircle,
          }),
          _react2.default.createElement(
            ...
            _extends(
              ...
              hoverHandler,
              {
                ...
                onDrag: this.handleLine1Edge2Drag,
                onDragComplete: onDragComplete,
              },
            ),
          ),
          ...
          _react2.default.createElement(
            ...
            _extends(
              ...
              hoverHandler,
              {
                startXY: [startXY[0], startXY[1] + (startXY[1] + endXY[1]) / 2],
                endXY: [endXY[0], endXY[1] + (startXY[1] + endXY[1]) / 2],
                dy: dy,
                stroke: 'green',
                strokeWidth: 0,
                strokeOpacity: strokeOpacity,
          ...
          _react2.default.createElement(_PositionTextWithRect2.default, {
            ref: this.saveNodeType('channel'),
            show: selected || hover,
            cx: (startXY[0] + endXY[0] + startXY[0] + endXY[0]) / 2,
            cy: (startXY[1] + endXY[1] + startXY[1] + endXY[1]) / 2,
            x1Value: 2 * startXY[0],
            y1Value: 2 * startXY[1],
            x2Value: 2 * endXY[0],
            y2Value: 2 * endXY[1],
  ...
  return EachLongPosition;
})(_react.Component);

EachLongPosition.propTypes = {
  ...
  infoBar: _propTypes2.default.object.isRequired,
...
exports.default = EachLongPosition;
//# sourceMappingURL=EachLongPosition.js.map
