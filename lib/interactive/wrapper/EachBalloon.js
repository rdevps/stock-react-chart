...
var _EachBalloonText = require('../components/EachBalloonText');

var _EachBalloonText2 = _interopRequireDefault(_EachBalloonText);
...
var EachBalloon = (function (_Component) {
  _inherits(EachBalloon, _Component);

  function EachBalloon(props) {
    _classCallCheck(this, EachBalloon);

    var _this = _possibleConstructorReturn(
      this,
      (EachBalloon.__proto__ || Object.getPrototypeOf(EachBalloon)).call(
        this,
        props,
      ),
    );
    ...
    },
    {
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(_EachBalloonText2.default, {
            ref: this.saveNodeType('edge2'),
            show: selected || hover,
...
EachBalloon.propTypes = {
  ...
  type: _propTypes2.default.oneOf(
    ['EachBalloon'], // extends between the set bounds
  ).isRequired,
  ...
  fillOpacity: _propTypes2.default.string.isRequired,
...
exports.default = EachBalloon;
//# sourceMappingURL=EachBalloon.js.map
