...
var PositionText = (function (_Component) {
  _inherits(PositionText, _Component);

  function PositionText(props) {
    _classCallCheck(this, PositionText);

    var _this = _possibleConstructorReturn(
      this,
      (PositionText.__proto__ || Object.getPrototypeOf(PositionText)).call(
        this,
        props
      )
    );
