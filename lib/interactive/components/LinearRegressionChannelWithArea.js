...
var LinearRegressionChannelWithArea = (function (_Component) {
  ...
  function LinearRegressionChannelWithArea(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (
        LinearRegressionChannelWithArea.__proto__ ||
        Object.getPrototypeOf(LinearRegressionChannelWithArea)
      ).call(this, props),
    );
    ...
    },
    {
      ...
      value: function drawOnCanvas(ctx, moreProps) {
        var _props2 = this.props,
          ...
          fill = _props2.fill,
          upFill = _props2.upFill,
          downFill = _props2.downFill,
          baseFill = _props2.baseFill;
    ...
    },
    {
      ...
      value: function renderSVG(moreProps) {
        var _props3 = this.props,
          ...
          fill = _props3.fill,
          upFill = _props3.upFill,
          downFill = _props3.downFill,
          baseFill = _props3.baseFill;
        ...
        var dy2 = dy / 2;
        var ctx1 = (0, _d3Path.path)();
        ctx1.moveTo(x1, y1 - dy);
        ctx1.lineTo(x2, y2 - dy);
        ctx1.lineTo(x2, y2 + dy);
        ctx1.lineTo(x1, y1 + dy);
        ctx1.closePath();
 ...
 */
  ...
  var _getClosestItemIndexe2 = (0, _utils.getClosestItemIndexes)(
      fullData,
      x2Value,
      xAccessor,
    ),
  ...
  var b =
    (n * (0, _d3Array.sum)(xys) -
      (0, _d3Array.sum)(xs) * (0, _d3Array.sum)(ys)) /
    (n * (0, _d3Array.sum)(xSquareds) - Math.pow((0, _d3Array.sum)(xs), 2));
  ...
  var stdDev =
    type === 'SD'
      ? (0, _d3Array.deviation)(array, function (d) {
          return d.close;
        })
      : 0;
