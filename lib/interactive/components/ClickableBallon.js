...
var ClickableBallon = (function (_Component) {
  _inherits(ClickableBallon, _Component);

  function ClickableBallon(props) {
    _classCallCheck(this, ClickableBallon);

    var _this = _possibleConstructorReturn(
      this,
      (
        ClickableBallon.__proto__ || Object.getPrototypeOf(ClickableBallon)
      ).call(this, props),
    );
...
exports.default = ClickableBallon;
//# sourceMappingURL=ClickableBallon.js.map
