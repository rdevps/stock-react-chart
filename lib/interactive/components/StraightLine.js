...
var StraightLine = (function (_Component) {
  ...
  function StraightLine(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (StraightLine.__proto__ || Object.getPrototypeOf(StraightLine)).call(
        this,
        props,
      ),
    );
  ...
  _createClass(StraightLine, [
    ...
    },
    {
      ...
      value: function renderSVG(moreProps) {
        ...
        x1Value = xAccessor(startItem)
        x2Value = xAccessor(lastItem)
...
function helper(props, moreProps) {
  ...
  var modLine = generateLine({
    type: type,
    start: [x1Value, y1Value],
    end: type === 'RAY' ? [x2Value, y1Value] : [x2Value, y2Value],
    xScale: xScale,
    yScale: yScale,
  });
...
function getHXLineCoordinates(_ref5) {
...
function getVXLineCoordinates(_ref5) {
  var end = _ref5.end,
    xScale = _ref5.xScale;
