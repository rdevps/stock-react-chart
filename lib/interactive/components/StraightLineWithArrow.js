...
var StraightLineWithArrow = (function (_Component) {
  _inherits(StraightLineWithArrow, _Component);

  function StraightLineWithArrow(props) {
    _classCallCheck(this, StraightLineWithArrow);

    var _this = _possibleConstructorReturn(
      this,
      (
        StraightLineWithArrow.__proto__ ||
        Object.getPrototypeOf(StraightLineWithArrow)
      ).call(this, props),
    );
  ...
  _createClass(StraightLineWithArrow, [
    {
      key: 'isHover',
    ...
    },
    {
      ...
      value: function drawOnCanvas(ctx, moreProps) {
        ...
        ctx.moveTo(x1, y1);
        ctx.lineTo(x2, y2);
        ctx.arcTo(x2, y2, x2 - 25, x2 + 25, 35);
        ctx.stroke();
      },
    },
    {
...
StraightLineWithArrow.propTypes = {
...
StraightLineWithArrow.defaultProps = {
...
exports.default = StraightLineWithArrow;
//# sourceMappingURL=StraightLineWithArrow.js.map
