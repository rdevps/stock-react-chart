...
var MouseLocationIndicator = (function (_Component) {
  ...
  function MouseLocationIndicator(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (
        MouseLocationIndicator.__proto__ ||
        Object.getPrototypeOf(MouseLocationIndicator)
      ).call(this, props),
    );
  ...
  _createClass(MouseLocationIndicator, [
    ...
    },
    {
      ...
      value: function xy(moreProps, e) {
        ...
        if (
          enabled &&
          (0, _utils.isDefined)(currentItem) &&
          (0, _utils.isDefined)(e)
        ) {
          var xValue =
            snap && !shouldDisableSnap(e)
              ? xAccessor(currentItem)
              : (0, _ChartDataUtil.getXValue)(
                  xScale,
                  xAccessor,
                  mouseXY,
                  plotData,
    ...
    },
    {
      ...
      value: function handleMousePosChange(moreProps, e) {
        if (
          !(0, _utils.shallowEqual)(moreProps.mousXY, moreProps.prevMouseXY)
        ) {
          var pos = this.xy(moreProps, e);
          if ((0, _utils.isDefined)(pos)) {
            var xValue = pos.xValue,
    ...
    },
    {
      ...
      value: function renderSVG(moreProps) {
        ...
        return enabled && show && (0, _utils.isDefined)(x)
