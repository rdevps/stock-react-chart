...
var ChannelWithArea = (function (_Component) {
  ...
  function ChannelWithArea(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (
        ChannelWithArea.__proto__ || Object.getPrototypeOf(ChannelWithArea)
      ).call(this, props),
    );
      ...
      value: function isHover(moreProps) {
        ...
        if ((0, _utils.isDefined)(onHover)) {
          var _helper = helper(this.props, moreProps),
            ...
            line2 = _helper.line2;
          var isInside = false
          if (line1.x1 < mouseXY[0] && line2.x2 > mouseXY[0] && line2.y2 > mouseXY[1] && line1.y1 < mouseXY[1]) {
            isInside = true
          }
    ...
    },
    {
      ...
      value: function renderSVG(moreProps) {
        ...
        if ((0, _utils.isDefined)(line1)) {
          ...
          var line = (0, _utils.isDefined)(line2)
