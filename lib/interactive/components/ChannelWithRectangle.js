...
var ChannelWithEllips = (function (_Component) {
  _inherits(ChannelWithEllips, _Component);

  function ChannelWithEllips(props) {
    _classCallCheck(this, ChannelWithEllips);

    var _this = _possibleConstructorReturn(
      this,
      (
        ChannelWithEllips.__proto__ || Object.getPrototypeOf(ChannelWithEllips)
      ).call(this, props),
    );
  ...
  _createClass(ChannelWithEllips, [
    {
      key: 'isHover',
...
ChannelWithEllips.defaultProps = {
...
exports.default = ChannelWithEllips;
