...
var PositionTextwithRect = (function (_Component) {
  _inherits(PositionTextwithRect, _Component);

  function PositionTextwithRect(props) {
    _classCallCheck(this, PositionTextwithRect);

    var _this = _possibleConstructorReturn(
      this,
      (
        PositionTextwithRect.__proto__ ||
        Object.getPrototypeOf(PositionTextwithRect)
      ).call(this, props),
    );
  ...
  _createClass(PositionTextwithRect, [
    {
      key: 'saveNode',
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _extends(
              ...
              {
                x: x - width / 2,
                y: y2 + (doubleLine ? 42 : height) / 2 - 9,
                rx: 7,
                ry: 7,
                width,
                height: doubleLine ? 42 : height,
              },
            ),
          ),
          _react2.default.createElement(
  ...
  return PositionTextwithRect;
})(_react.Component);

function helper(props, moreProps) {
  const cyVal = props.y1Value > props.y2Value ? props.y2Value : props.y1Value;
  ...
  var x = xScale(cx);
  var y = yScale(cy);
  var x1Value = xScale(props.x1Value);
  var y1Value = yScale(props.y1Value);
  var x2Value = xScale(props.x2Value);
  var y2Value = yScale(cyVal);
  return [x, y, x1Value, y1Value, x2Value, y2Value];
}
PositionTextwithRect.propTypes = {
  ...
  doubleLine: _propTypes2.default.bool.isRequired,
  strokeOpacity: _propTypes2.default.number.isRequired,
  fillOpacity: _propTypes2.default.number.isRequired,
  interactiveCursorClass: _propTypes2.default.string,
};

PositionTextwithRect.defaultProps = {
...
exports.default = PositionTextwithRect;
//# sourceMappingURL=PositionTextwithRect.js.map
