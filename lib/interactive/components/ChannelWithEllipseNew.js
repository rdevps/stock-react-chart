...
var ChannelWithEllipseNew = (function (_Component) {
  _inherits(ChannelWithEllipseNew, _Component);

  function ChannelWithEllipseNew(props) {
    _classCallCheck(this, ChannelWithEllipseNew);

    var _this = _possibleConstructorReturn(
      this,
      (
        ChannelWithEllipseNew.__proto__ ||
        Object.getPrototypeOf(ChannelWithEllipseNew)
      ).call(this, props),
    );
  ...
  _createClass(ChannelWithEllipseNew, [
    {
      key: 'isHover',
      value: function isHover(moreProps) {
        ...
        if ((0, _utils.isDefined)(onHover)) {
          ...
          var rx = Math.sqrt(a * a + b * b);

          var hovering =
            parseInt(Math.pow(mouseXY[0] - cx, 2)) /
            parseInt(Math.pow(rx + 2, 2)) +
            parseInt(Math.pow(mouseXY[1] - cy, 2)) /
            parseInt(Math.pow(ry + 2, 2));

          return !parseInt(hovering);
        }
        return false;
      },
    },
    ...
    },
    {
      ...
      value: function renderSVG(moreProps) {
        ...
        var x2 = xScale(x2Value);
        var y2 = yScale(y2Value);
        const angleData = angle(x1, y1, x2, y2);
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement('ellipse', {
            ...
            fill,
            fillOpacity,
            transform: `rotate(${angleData * -1} ${cx} ${cy})`,
          }),
        );
      },
    },
...
ChannelWithEllipseNew.propTypes = {
...
ChannelWithEllipseNew.defaultProps = {
...
exports.default = ChannelWithEllipseNew;
