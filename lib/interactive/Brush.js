...
var Brush = (function (_Component) {
  ...
  function Brush(props, context) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (Brush.__proto__ || Object.getPrototypeOf(Brush)).call(
        this,
        props,
        context,
      ),
    ...
    _this.onEscapeKey = _this.onEscapeKey.bind(_this);
    document.addEventListener('keyup', _this.onEscapeKey);
    _this.state = {
      rect: null,
    };
    return _this;
    ...
    },
    {
      ...
      value: function drawOnCanvas(ctx) {
        ...
        if ((0, _utils.isDefined)(rect)) {
          ...
          var dashArray = (0, _utils.getStrokeDasharray)(strokeDashArray)
            .split(',')
            .map(function (d) {
              return +d;
            });
