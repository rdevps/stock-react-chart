...
var EquidistantChannel = (function (_Component) {
  ...
  function EquidistantChannel(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (
        EquidistantChannel.__proto__ ||
        Object.getPrototypeOf(EquidistantChannel)
      ).call(this, props),
    );
  ...
  _createClass(EquidistantChannel, [
    {
      ...
      value: function handleDragChannel(index, newXYValue, props) {
    ...
    },
    {
      ...
      value: function handleClick(index, moreProps) {
        ...
        var newChannels = channels.map(function (each, idx) {
          return idx === index ? _extends({}, each, { selected: true }) : each;
        });
        this.setState(
          {
            override: null,
    ...
    },
    {
      ...
      value: function onDoubleClickWhenHover(index, moreProps) {
        ...
        var newChannels = channels.map(function (each, idx) {
          return idx === index ? _extends({}, each, { selected: true, isEdit: true }) : each;
        });
        this.setState(
          {
            override: null,
    ...
    },
    {
      ...
      value: function render() {
        ...
        var _props4 = this.props,
          ...
          hoverText =
            !isLocked && _props2.selectedInteraction
              ? _props4.hoverText
              : { show: false };
          ...
          (0, _utils.isDefined)(current) && (0, _utils.isDefined)(current.endXY)
            ? _react2.default.createElement(
              ...
              _react2.default.createElement(_ToolsExtraData2.default, {
                ...
                x1Value: current.startXY[0],
                y1Value: current.startXY[1],
                x2Value: current.endXY[0],
                y2Value: current.endXY[1],
                dy: current.dy,
                startItem: startItem,
                lastItem: lastItem,
                selected: true,
              ...
              _react2.default.createElement(
                _EachEquidistantChannel2.default,
                _extends(
                  {
                    interactive: false,
                  },
