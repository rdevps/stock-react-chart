...
var TrendLine = (function (_Component) {
  ...
  function TrendLine(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (TrendLine.__proto__ || Object.getPrototypeOf(TrendLine)).call(
        this,
        props,
      ),
    );
          ...
          (0, _utils.isDefined)(current) && (0, _utils.isDefined)(current.end)
            ? _react2.default.createElement(
              ...
              _react2.default.createElement(
                'g',
                null,
                _react2.default.createElement(_EachTrendLine2.default, {
                  type: type,
                  noHover: true,
                  timeSpan: timeSpan,
                  startItem: startItem,
          ...
          trends.map(function (each, idx) {
            ...
            var hoverTextWithDefault =
              (_props2.selectedInteraction &&
                _extends({}, TrendLine.defaultProps.hoverText, hoverText)) ||
              {};
