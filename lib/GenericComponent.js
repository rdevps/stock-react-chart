...
var GenericComponent = (function (_Component) {
  ...
  function GenericComponent(props, context) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (
        GenericComponent.__proto__ || Object.getPrototypeOf(GenericComponent)
  ...
  _createClass(GenericComponent, [
        ...
        switch (type) {
          ...
          case 'mousemove': {
            ...
            if (
              ...
              (0, _utils.isDefined)(this.props.onHover)
            ) {
    ...
    },
    {
      ...
      value: function isHover(e) {
        return (0, _utils.isDefined)(this.props.isHover)
    ...
    },
    {
      ...
      value: function draw() {
        ...
        if (
          ...
          if (
            (0, _utils.isNotDefined)(canvasDraw) ||
            chartCanvasType === 'svg'
          ) {
    ...
    */
    ...
    },
    {
      ...
      value: function getMoreProps() {
        ...
        //   console.log(
        //     'getMoreProps this.context',
        //     this.context,
        //     this.context.getCanvasContexts(),
...
GenericComponent.propTypes = {
  ...
  drawInteraction: _propTypes2.default.bool.isRequired,
...
GenericComponent.contextTypes = {
  ...
  chartConfig: _propTypes2.default.oneOfType([
