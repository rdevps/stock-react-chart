...
var EdgeIndicator = (function (_Component) {
  ...
  function EdgeIndicator(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (EdgeIndicator.__proto__ || Object.getPrototypeOf(EdgeIndicator)).call(
        this,
        props,
      ),
    );
...
EdgeIndicator.propTypes = {
  ...
  lineStroke: _propTypes2.default.oneOfType([
    _propTypes2.default.string,
    _propTypes2.default.func,
  ]),
  textFill: _propTypes2.default.oneOfType([
    _propTypes2.default.string,
    _propTypes2.default.func,
  ]),
...
function helper(props, moreProps) {
  ...
  var item =
    itemType === 'first'
      ? (0, _utils.first)(plotData, yAccessor)
      : (0, _utils.last)(plotData, yAccessor);

  // var currentItem = ChartDataUtil.getCurrentItemForChartNew(currentItems, forChart);
  var edge = (0, _utils.isDefined)(item)
