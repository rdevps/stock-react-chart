...
var Triangle = (function (_Component) {
  ...
  function Triangle(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (Triangle.__proto__ || Object.getPrototypeOf(Triangle)).call(this, props),
    );
      ...
      value: function renderSVG(moreProps) {
        ...
        if (position === 'fixed') {
          ...
          cy =
            ...
            yScale(yScale.invert(size * 2 - size / 2));
          if (position === 'bottom') {
            cy = yScale(selectedCandle.low) + yScale(yScale.invert(size / 2));
          }
        }
        ...
        var points = `${tx},${ty - size / 2} ${tx - size / 2},${ty + size / 2
          } ${tx + size / 2},${ty + size / 2}`;
