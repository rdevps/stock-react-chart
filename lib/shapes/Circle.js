...
var Circle = (function (_Component) {
  ...
  function Circle(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (Circle.__proto__ || Object.getPrototypeOf(Circle)).call(this, props),
    );
  ...
  _createClass(Circle, [
    ...
    },
    {
      ...
      value: function renderSVG(moreProps) {
        ...
        var location = this.props.location || 'bottomRight';
        ...
        if (position === 'fixed') {
          ...
          cy = yScale(selectedCandle.high) - yScale(yScale.invert(size + 3));
          if (position === 'bottom') {
            cy = yScale(selectedCandle.low) + yScale(yScale.invert(size + 3));
          }
        }
